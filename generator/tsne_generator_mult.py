...
real_labels = pd.read_csv('C:/Users/nilox/OneDrive/NINFA/Dataset/features_all.csv', sep=';',
...
def make_TSNE(path, esp, files, out_path):
    ...
    main_data["p_label"] = tsne_data.p_label
...
if __name__ == "__main__":
    ...
    for file in os.listdir(path):
        ...
        all_data.update({esp : [file]} if all_data[esp] == None else {esp : all_data[esp] + [file]})
