...
number_to_color_dict = {0: normal, 1: rubbing, 2: faulty, 3: misalignment,
                        4: unbalance}#, 5: num5, 6: num6, 7: num7, 8: num8, 9: num9}
color_to_number_dict = {v: k for k, v in number_to_color_dict.items()}

color_to_name_dict = {normal: 'Normal',  unbalance: 'Unbalance',
                      faulty: 'Faulty sensor', rubbing: 'Rubbing', misalignment: 'Misalignment'}
